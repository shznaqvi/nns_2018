...
import edu.aku.hassannaqvi.nns_2018_lab_app.Adapters.syncListAdapter;
import edu.aku.hassannaqvi.nns_2018_lab_app.Adapters.upload_list_adapter;
...
import edu.aku.hassannaqvi.nns_2018_lab_app.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.nns_2018_lab_app.get.GetAllData;
import edu.aku.hassannaqvi.nns_2018_lab_app.other.SyncModel;
import edu.aku.hassannaqvi.nns_2018_lab_app.sync.SyncAllData;
...
public class SyncActivity extends AppCompatActivity implements SyncDevice.SyncDevicInterface {
    ...
    public void processFinish(boolean flag) {
        if (flag) {
            HashMap<String, String> tagVal = edu.aku.hassannaqvi.nns_2018.core.MainApp.getTagValues(this);
