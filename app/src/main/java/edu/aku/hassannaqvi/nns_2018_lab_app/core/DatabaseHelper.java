...
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.ChildContract.ChildTable;
...
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.EligibleMembersContract.eligibleMembers;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.EnumBlockContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.EnumBlockContract.EnumBlockTable;
...
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.MWRAContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.MWRAContract.MWRATable;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.MicroContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.NutritionContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.NutritionContract.NutritionTable;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.OutcomeContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.OutcomeContract.outcomeTable;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.RecipientsContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.RecipientsContract.RecipientsTable;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.SerialContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.SerialContract.singleSerial;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.SpecimenContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.SummaryContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.SummaryContract.singleSum;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.UCsContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.UCsContract.UCsTable;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.UsersContract;
import edu.aku.hassannaqvi.nns_2018_lab_app.contracts.UsersContract.UsersTable;
...
//        db.delete(singleRandomHH.TABLE_NAME, null, null);
    ...
    public boolean checkHHExists(String cluster, String hh) {
        SQLiteDatabase db = this.getReadableDatabase();
        String query = "SELECT * FROM " + singleRandomHH.TABLE_NAME + " WHERE " + singleRandomHH.COLUMN_ENUM_BLOCK_CODE + "='" + cluster + "' AND " + singleRandomHH.COLUMN_HH + "= '" + hh+"'";
    ...
    public void saveAnthroMembersFromServer(FamilyMembersContract fmc) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
...
// Create a new map of values, where column names are the keys
        ...
        //values.put(WaterSpecimenContract.MicroTable.COLUMN_FM_UID, fmc.getFMUID());
        ...
        //values.put(SpecimenContract.SpecimenTable.COLUMN_WUID, fmc.getLineNo());
...
// Which row to update, based on the ID
    ...
    public Collection<WaterSpecimenContract> getUnsyncedWaterSpecimenForms() {
        ...
        String[] columns = {
                ...
                WaterSpecimenContract.WaterSpecimenTable.COLUMN__UID,
                WaterSpecimenContract.WaterSpecimenTable.COLUMN__UUID,
                //WaterSpecimenContract.MicroTable.COLUMN_FM_UID,
                WaterSpecimenContract.WaterSpecimenTable.COLUMN_FORMDATE,
                WaterSpecimenContract.WaterSpecimenTable.COLUMN_USER,
                //WaterSpecimenContract.MicroTable.COLUMN_WUID,
                WaterSpecimenContract.WaterSpecimenTable.COLUMN_HH,
                WaterSpecimenContract.WaterSpecimenTable.COLUMN_CLUSTER,
                WaterSpecimenContract.WaterSpecimenTable.COLUMN_SE2,
                WaterSpecimenContract.WaterSpecimenTable.COLUMN_DEVICEID,
