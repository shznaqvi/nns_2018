package edu.aku.hassannaqvi.nns_2018_val.core;
...
import edu.aku.hassannaqvi.nns_2018_val.contracts.BLRandomContract.singleRandomHH;
...
import edu.aku.hassannaqvi.nns_2018_val.contracts.EnumBlockContract.EnumBlockTable;
import edu.aku.hassannaqvi.nns_2018_val.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.FamilyMembersContract.familyMembers;
import edu.aku.hassannaqvi.nns_2018_val.contracts.FormsContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.nns_2018_val.contracts.MWRAContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.MWRAContract.MWRATable;
...
import edu.aku.hassannaqvi.nns_2018_val.contracts.NutritionContract.NutritionTable;
import edu.aku.hassannaqvi.nns_2018_val.contracts.OutcomeContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.OutcomeContract.outcomeTable;
import edu.aku.hassannaqvi.nns_2018_val.contracts.RecipientsContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.RecipientsContract.RecipientsTable;
import edu.aku.hassannaqvi.nns_2018_val.contracts.SerialContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.SerialContract.singleSerial;
import edu.aku.hassannaqvi.nns_2018_val.contracts.SpecimenContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.SummaryContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.SummaryContract.singleSum;
import edu.aku.hassannaqvi.nns_2018_val.contracts.UCsContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.UCsContract.UCsTable;
import edu.aku.hassannaqvi.nns_2018_val.contracts.UsersContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.UsersContract.UsersTable;
import edu.aku.hassannaqvi.nns_2018_val.contracts.VersionAppContract;
import edu.aku.hassannaqvi.nns_2018_val.contracts.VersionAppContract.VersionAppTable;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    final String SQL_CREATE_TALUKA = "CREATE TABLE " + EnumBlockTable.TABLE_NAME + " (" +
            ...
            EnumBlockTable.COLUMN_EN_HHNO + " TEXT, " +
            EnumBlockTable.COLUMN_EN_HH03 + " TEXT, " +
            EnumBlockTable.COLUMN_EN_HH07 + " TEXT " +
            ");";
    ...
    public void syncEnumBlocks(JSONArray Enumlist) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                values.put(EnumBlockTable.COLUMN_EN_HHNO, Vc.getEn_hhno());
                values.put(EnumBlockTable.COLUMN_EN_HH03, Vc.getEn_hh03());
                values.put(EnumBlockTable.COLUMN_EN_HH07, Vc.getEn_hh07());
...
//                    }
    ...
    public ArrayList<EnumBlockContract> getEnumBlock(String cluster) {
        ...
        String[] columns = {
                ...
                EnumBlockTable.COLUMN_EN_HHNO,
                EnumBlockTable.COLUMN_EN_HH03,
                EnumBlockTable.COLUMN_EN_HH07
        };
