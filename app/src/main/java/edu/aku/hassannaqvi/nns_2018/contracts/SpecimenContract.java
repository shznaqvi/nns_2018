...
public class SpecimenContract {
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        //json.put(SpecimenTable.COLUMN_MUID, this.MUID == null ? JSONObject.NULL : this.MUID);
        ...
        if (!this.sE1.equals("")) {
            ...
            /*  json.put(SpecimenTable.COLUMN_SC1, this.sC1 == null ? JSONObject.NULL : this.sC1);*/
        }
        ...
        /*json.put(SpecimenTable.COLUMN_SYNCED, this.synced == null ? JSONObject.NULL : this.synced);
        json.put(SpecimenTable.COLUMN_SYNCED_DATE, this.synced_date == null ? JSONObject.NULL : this.synced_date);*/
