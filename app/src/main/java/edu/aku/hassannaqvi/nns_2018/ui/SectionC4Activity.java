...
import edu.aku.hassannaqvi.nns_2018.JSONModels.JSONC4ModelClass;
...
//        nc4079603x
                ...
                //    fldGrnc408check
                if (!validatorClass.EmptyCheckBox(this, binding.fldGrnc408check, binding.nc408a, getString(R.string.nc408))) {
                    return false;
                }
